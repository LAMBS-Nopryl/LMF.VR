...
//INFANTRY UNIFORM
private _Uniform = ["U_B_CombatUniform_mcam","U_B_CombatUniform_mcam_vest"]; // Uniform
private _Vest = ["V_PlateCarrier1_rgr"]; // Vest
private _Headgear = ["H_HelmetSpecB","H_HelmetSpecB_blk","H_HelmetSpecB_paint2","H_HelmetSpecB_paint1","H_HelmetSpecB_sand","H_HelmetSpecB_snakeskin"]; // Headgear
private _Goggles = ["G_Shades_Black",""]; // Goggles

//PILOT UNIFORM
private _Heli_Uniform = ["U_B_HeliPilotCoveralls"]; // Pilot Uniform
private _Heli_Vest = ["V_TacVest_blk"]; // Pilot Vest
...
private _Crew_Uniform = ["U_B_CombatUniform_mcam_tshirt"]; // Crew Uniform
private _Crew_Vest = ["V_BandollierB_rgr"]; // Crew Vest
private _Crew_Headgear = ["H_HelmetCrew_B"]; // Crew Headgear
private _Crew_Goggles = ["G_Combat",""]; // Goggles

//BACKPACKS
private _Backpack_Leader = ["B_TacticalPack_mcamo"]; // Plt.Lead, Plt.Sgt, Squad Leader
...
private _Backpack_Light = ["B_AssaultPack_mcamo"]; // Everyone else if given backpacks
...
private _Carbine_Attach1 = "acc_pointer_ir"; // Carbine Attachment #1
...
private _Rifle_Attach1 = "acc_pointer_ir"; // Rifle Attachment #1
...
private _Rifle_GL_Attach1 = "acc_pointer_ir"; // GL Rifle Attachment #1
...
private _LMG_Attach1 = "acc_pointer_ir"; // LMG Attachment #1
...
private _MMG_Attach1 = "acc_pointer_ir"; // MMG Attachment #1
